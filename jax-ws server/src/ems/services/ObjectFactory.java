 ...
 * generated in the ems.services package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetEmployeeById_QNAME = new QName("http://services.ems/", "getEmployeeById");
    private final static QName _GetEmployeeByIdResponse_QNAME = new QName("http://services.ems/", "getEmployeeByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ems.services
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.ems/", name = "getEmployeeById")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://services.ems/", name = "getEmployeeByIdResponse")
